...
Logging lets us revisit our application as if it were running. It's a useful tool for tracking bugs, performance, and generally ensuring that our applications are chugging along.
